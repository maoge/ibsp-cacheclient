...
public class FunctionTest {
    ...
    public FunctionTest() throws IOException {
        ...
        this.cacheService = CacheService.getInstance(groupid);
    }
    ...
    public void TC_001() {
        ...
        /** SET **/
        try {
            String status = cacheService.set( groupid, Key, Value );
            if (status.equals("0")) {
                logger.info("set测试通过！");
            } else {
        ...
        /** APPEND **/
        try {
            long result = cacheService.append( groupid, Key, "123456" );
            if (result==9) {
        ...
        /** SETNX **/
        try {
            long result = cacheService.setnx( groupid, Key, "123456" );
            if (result==0) {
        ...
        /** SETEX **/
        try {
            String status = cacheService.setex( groupid, Key, 30, "123456" );
            if (status.equals("0")) {
        ...
        /** GETSET **/
        try {
            byte[] byteValue = cacheService.getSet(groupid, Key, "abcdefg");
        ...
        /** SETRANGE **/
        try {
            long result = cacheService.setrange(groupid, Key, 0, "9876543210");
            if (result==10) {
        ...
        /** GETRANGE **/
        try {
            byte[] byteValue = cacheService.getrange(groupid, Key, 5, 10);
        ...
        /** STRLEN **/
        try {
            long result = cacheService.strlen(groupid, Key);
            if (result==10) {
        ...
        /** INCR **/
        try {
            cacheService.set( groupid, "zoo", "0" );
            long result = cacheService.incr(groupid, "zoo");
            if (result==1) {
        ...
        /** DECR **/
        try {
            long result = cacheService.decr(groupid, "zoo");
            if (result==0) {
        ...
        /** INCRBY **/
        try {
            long result = cacheService.incrBy(groupid, "zoo", 10);
            if (result==10) {
        ...
        /** DECRBY **/
        try {
            long result = cacheService.decrBy(groupid, "zoo", 5);
            if (result==5) {
        ...
        /** EXISTS **/
        try {
            boolean bResult = cacheService.exists(groupid, "test");
            if (!bResult) {
        ...
        /** TYPE **/
        try {
            String value = cacheService.type(groupid, "zoo");
        ...
        /** EXPIRE **/
        try {
            long result = cacheService.expire(groupid, Key, 60);
            if (result==1) {
        ...
        /** TTL **/
        try {
            long result = cacheService.ttl(groupid, Key);
            if (result==57) {
                logger.info("ttl测试通过！");
            } else {
        ...
        /** PEXPIRE **/
        try {
            long result = cacheService.pexpire(groupid, Key, 5000);
            if (result==1) {
        ...
        /** PTTL **/
        try {
            long result = cacheService.pttl(groupid, Key);
        ...
        /** PERSIST **/
        try {
            long result = cacheService.persist(groupid, Key);
            if (result==1) {
        ...
        /** DEL **/
        try {
            long flag = cacheService.del( groupid, Key );
            if (flag==1) {
                logger.info("del测试通过！");
            } else {
    ...
    public void TC_002() {
        ...
        cacheService.del( groupid, hashKey );
        /** HMSET **/
        try {
            String result = cacheService.hmset(groupid, hashKey, map);
            if (result.equals("OK")) {
        ...
        /** HSETNX **/
        try {
            long flag = cacheService.hsetnx(groupid, hashKey, field4, value4);
            if (flag==1) {
        ...
        /** HSET **/  
        try {
            long flag = cacheService.hset(groupid, hashKey, field1, "+value1");
            if (flag==0) {
        ...
        /** HGET **/    
        try {
            String result = cacheService.hget(groupid, hashKey, field1);
        ...
        /** HMGET **/
        try {
            List<String> lstResult = cacheService.hmget(groupid, hashKey, field1, field2, field3, field4);
            if (lstResult.size()==4) {
        ...
        try {
            ...
            List<byte[]> lstResult2 = cacheService.hmgetBytes( groupid, hashKey, temp);
        ...
        /** HMGETALL **/
        try {
            Map<String, String> mapResult = cacheService.hgetAll(groupid, hashKey);
            if (mapResult.size()==4) {
        ...
        /** HKEYS **/
        try {
            Set<String> setResult = cacheService.hkeys(groupid, hashKey);
            if (setResult.size()==4) {
        ...
        /** HVALS **/
        try {
            List<byte[]> byteResult = cacheService.hvals(groupid, hashKey);
        ...
        /** HINCRBY **/
        try {
            long flag = cacheService.hincrBy(groupid, hashKey, field5, 5);
            if (flag==5) {
        ...
        /** HEXISTS **/
        try {
            boolean bResult = cacheService.hexists(groupid, hashKey, field5);
            if (bResult) {
        ...
        /** HLEN **/    
        try {
            long flag = cacheService.hlen(groupid, hashKey);
            if (flag==5) {
        ...
        /** HDEL **/  
        try {
            long flag = cacheService.hdel(groupid, hashKey, field1, field2);
            if (flag==2) {
    ...
    public void TC_004() {
        ...
        cacheService.del( groupid, listKey );
        /** LPUSH **/
        try {
            long result = cacheService.lpush(groupid, listKey, value1, value2, value3, value4);
            if (result==4) {
        ...
        /** RPUSH **/
        try {
            long result = cacheService.rpush(groupid, listKey, value5);
            if (result==5) {
        ...
        /** LPUSHX **/ 
        try {
            long result = cacheService.lpushx(groupid, listKey, value6);
            if (result==6) {
        ...
        /** RPUSHX **/    
        try {
            long result = cacheService.rpushx(groupid, listKey, value7);
            if (result==7) {
        ...
        /** LPOP **/
        try {
            String value = cacheService.lpop(groupid, listKey);
            if (value!=null) {
        ...
        /** RPOP **/   
        try {
            String value = cacheService.rpop(groupid, listKey);
            if (value!=null) {
        ...
        /** LINSERT **/    
        try {
            long result = cacheService.linsert(groupid, listKey, false, value6, value8);
            if (result==6) {
        ...
        /** LLEN **/ 
        try {
            long result = cacheService.llen(groupid, listKey);
            if (result==6) {
        ...
        /** LRANGE **/
        try {
            List<byte[]> lstResult = cacheService.lrange(groupid, listKey, 1, 4);
            if (lstResult.size()==4) {
        ...
        /** LTRIM **/
        try {
            String status = cacheService.ltrim(groupid, listKey, 0, 5);
            if (status.equals("OK")) {
        ...
        /** LINDEX **/
        try {
            String value = cacheService.lindex(groupid, listKey, 0);
            if (value!=null) {
        ...
        /** LSET **/    
        try {
            String status = cacheService.lset(groupid, listKey, 0, value1);
            if (status.equals("OK")) {
        ...
        try {
            long result = cacheService.lrem(groupid, listKey, 0, value1);
            if (result==2) {
    ...
    public void TC_005() {
        ...
        cacheService.del( groupid, setKey );
        /** SADD **/
        try {
            long result = cacheService.sadd(groupid, setKey, value1, value2, value3);
            if (result==3) {
        ...
        /** SCARD **/
        try {
            long result = cacheService.scard(groupid, setKey);
            if (result==3) {
        ...
        /** SISMEMBER **/
        try {
            boolean bResult = cacheService.sismember(groupid, setKey, value3);
            if (bResult) {
        ...
        /** SMEMBER **/
        try {
            Set<byte[]> setResult = cacheService.smembers(groupid, setKey);
            if (setResult.size()==3) {
        ...
        /** SREM **/
        try {
            long result = cacheService.srem(groupid, setKey, value3);
            if (result==1) {
    ...
    public void TC_0051() {
        ...
        cacheService.del( groupid, zSetKey );
        /** ZADD **/
        try {
            long result = cacheService.zadd(groupid, zSetKey, zmap);
            long result2 = cacheService.zadd(groupid, zSetKey, value4, field4);
        ...
        /** ZCARD **/
        try {
            long result = cacheService.zcard(groupid, zSetKey);
            if (result==5) {
        ...
        /** ZSCORE **/
        try {
            double dResult = cacheService.zscore(groupid, zSetKey, field1);
        ...
        /** ZCOUNT **/
        try {
            long result = cacheService.zcount(groupid, zSetKey, 0, 5);
            if (result==4) {
        ...
        /** ZRANGE **/   
        try {
            Set<String> setResult = cacheService.zrange(groupid, zSetKey, 0, -1);
            if (setResult.size()==5) {
        ...
        /** ZRANGEBYSCORE **/
        try {
            Set<String> setResult = cacheService.zrangeByScore(groupid, zSetKey, 0, 900);
            if (setResult.size()==5) {
        ...
        try {
            Set<Tuple> tResult = cacheService.zrangeByScoreWithScores(groupid, zSetKey, 3d, 10d);
            if (tResult.size()==3) {
        ...
        /** ZRANGEBYSCORE **/
        try {
            long result = cacheService.zremrangeByRank(groupid, zSetKey, 0, 0);
            if (result==1) {
        ...
        /** ZRANGEBYSCORE **/
        try {
            long result = cacheService.zremrangeByScore(groupid, zSetKey, 2, 4);
            if (result==3) {
        ...
        /** ZRANGEBYSCORE **/
        try {
            double dResult = cacheService.zincrby(groupid, zSetKey, 3.14159262789, field2);
        ...
        /** ZREM **/
        try {
            long result = cacheService.zrem(groupid, zSetKey, field1);
            if (result==0) {
    ...
    public void TC_006() {
        ...
        /** GET **/
        try {
            byte[] value2 = cacheService.getBytes( groupid, Key );
        ...
        /** SETNX **/
        try {
            long result = cacheService.setnx( groupid, Key, value );
            if (result==0) {
        ...
        /** SETEX **/
        try {
            String status = cacheService.setex( groupid, Key, 30, "abcdefg中文绰号测试".getBytes() );
            if (status.equals("0")) {
                logger.info("setex测试通过！");
            } else {
                logger.info("setex测试失败！返回值错误。");
        ...
        /** GETSET **/
        try {
            byte[] value3 = cacheService.getSet(groupid, Key, value);
    ...
    public void TC_008() {
        ...
        /** HSCAN **/       
        try {
            ScanResult<Map<byte[], byte[]>> result = cacheService.hscan( groupid, hashKey, "0" );
            if (result!=null) {
