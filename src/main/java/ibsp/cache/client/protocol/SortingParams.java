...
import static ibsp.cache.client.protocol.Protocol.Keyword.ALPHA;
import static ibsp.cache.client.protocol.Protocol.Keyword.ASC;
import static ibsp.cache.client.protocol.Protocol.Keyword.BY;
import static ibsp.cache.client.protocol.Protocol.Keyword.DESC;
import static ibsp.cache.client.protocol.Protocol.Keyword.GET;
import static ibsp.cache.client.protocol.Protocol.Keyword.LIMIT;
import static ibsp.cache.client.protocol.Protocol.Keyword.NOSORT;
