 ...
 * @since v1.0.13
 * @version v1.2.0
 * @说明 连接池，非单例，一个分组一个连接池
 * 连接池有一个Reconnector和一个Checker线程，连接池中的每个异步连接有一个Reader和一个Writer线程，同步连接没有多余线程
 */
...
public abstract class ConnectionPool {
	...
	protected Map<Exception, String> excepts =
			Collections.synchronizedMap(new HashMap<Exception, String>());
		...
		synchronized (this.excepts) {
			for (Exception e : this.excepts.keySet()) {
				if (((e instanceof SocketException)) || ((e instanceof SocketTimeoutException)) || ((e instanceof ConnectException)) 
						|| ((e instanceof ProxyRedisException)) || ((e instanceof IOException)) || ((e instanceof RuntimeException))) {
